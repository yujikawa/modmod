...
All generated agent configuration files SHALL contain a direct instruction to read `.modscape/rules.md` before performing modeling tasks.

#### Scenario: Verifying .clauderules content
- **WHEN** the system generates `.clauderules`
- **THEN** the file includes the text "BEFORE making any suggestions or changes, you MUST read and strictly follow the rules defined in .modscape/rules.md"
